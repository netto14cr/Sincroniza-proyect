...
public class BeanTransCaja2 implements Serializable {
    ...
    public BeanTransCaja2(String eNumCuenta, String eTipoBusqueda) {
        this.eNumCuenta = eNumCuenta;
        this.eTipoBusqueda = eTipoBusqueda;
    }
    ...
    // no pertenece al usuario cajero
     ...
     public BeanTransCaja2(String eCedula, String eTipoBusqueda, List<cuenta> lista, 
             boolean eExitenciaCuenta) {
        this.eCedula = eCedula;
        this.eTipoBusqueda = eTipoBusqueda;
        this.lista = lista;
    ...
    public BeanTransCaja2(String eNumCuenta, String eCedula,
    ...
    public BeanTransCaja2(String eMensaje) {
        this.eMensaje = eMensaje;
    }
    
     public BeanTransCaja2(String eNumCuenta,String eTipoBusqueda, boolean eExitenciaCuenta, 
    ...
    public String toString() {
        return "BeanTransCaja2{" + "eCedula=" + eCedula + ", eCedulaDet=" 
                + eCedulaDet + ", eNumCuenta=" + eNumCuenta + ", eNombreUs=" 
                + eNombreUs + ", eMontoDeposito=" + eMontoDeposito 
                + ", eMonedaDeposito=" + eMonedaDeposito + ", eDetalleDeposito=" 
                + eDetalleDeposito + ", eTipoBusqueda=" + eTipoBusqueda 
                + ", lista=" + lista + ", eMensaje=" + eMensaje + ", eExitenciaCuenta=" 
                + eExitenciaCuenta + ", cuentaSeleccionada=" + cuentaSeleccionada + '}';
    }
