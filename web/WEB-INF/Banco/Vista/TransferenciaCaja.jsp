    ...
    <body>
        <div id="wrapper">
            ...
            <div id="contents">
                ...
                <form method="GET" action="busquedaCuentaRetiro-cajero" class="e-BuscaTransferenciaCaja" 
                      onsubmit="return validarForumlarioDeposito1()">

                    <p style="text-align: center;"> Busqueda cuenta Origen </p>
                ...
                <form method="GET" action="busquedaCuentaRetiro-cajero" class="e-BuscaTransferenciaCaja" 
                    ...
                    <p style="text-align: center;"> Busqueda cuenta Destino </p>
                    <!--Campo para ingresar la identificación-->
                    <p>
                        <label class="texto">Buscar cuenta por:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        <select id="tipoBusquedaCuenta" name="tipoBusquedaCuenta" class="select">
